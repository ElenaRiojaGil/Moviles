...
public class GridPeliculas extends AppCompatActivity  implements LstFilmsContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlstPelis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cambioList = new Intent(getApplicationContext(), com.enrique.rakutentv.ListaPeliculas.class);
    ...
    public void sucessListFilms(final ArrayList<Film> lstFilms) {
        ...
        adapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent cambio1 = new Intent(getApplicationContext(), com.enrique.rakutentv.FichaPelicula.class);
